...
SERIES = {
    "population_stability": [("dead_pct", "Unalive"), ("evacuated_pct", "Evacuated"), ("stranded_pct", "Stranded"), ("in_shelter_pct", "In Shelter"), ("in_healthcare_pct", "In Healthcare")],
...
FIGURES: dict[str, dict[str, Any]] = {
    ...
    "infectious_population_stability": {"scenario": "infectious_disease", "kind": "lines", "series": [("dead_pct", "Unalive"), ("inf_prev_pct", "Active infections"), ("in_healthcare_pct", "In Healthcare")], "filename": "08_infectious_population_stability", "title": "Population Stability - Infectious Disease Scenario", "xlabel": "Day", "ylabel": "Percentage of population"},
...
def _plot_lines(df: pd.DataFrame, spec: dict[str, Any], out: Path, unit: str, tick: float) -> bool:
    ...
    for base, label in spec["series"]:
        ...
        stability_colors = {"Unalive": "black", "Evacuated": "green", "Stranded": "red", "In Shelter": "blue", "In Healthcare": "orange"}
